        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {services.map((service, index) => {
            ...
            return (
              ...
              >
                <div className={`w-14 h-14 rounded-xl flex items-center justify-center mb-6 ${service.color || 'bg-white-500/10 text-white-500'} group-hover:scale-110 transition-transform`}>
                  <Icon size={28} />
                </div>
